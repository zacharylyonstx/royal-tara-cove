  ...
  useFrame((_, dtRaw) => {
    ...
    if (net.myCharacterId) {
      ...
      if (rev !== lastWardrobeRev.current) {
        ...
        broadcastWardrobe({ characterId: net.myCharacterId, appearance: ws.appearances[net.myCharacterId], realMode: ws.realMode[net.myCharacterId], realLook: ws.realLooks[net.myCharacterId] });
      }
    }
